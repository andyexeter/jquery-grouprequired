...
#### Download
* [jquery.grouprequired.min.js](https://unpkg.com/jquery-grouprequired@2.3.0/dist/jquery.grouprequired.min.js) (1.52kB, 687B gzipped)
* [jquery.grouprequired.js](https://unpkg.com/jquery-grouprequired@2.3.0/dist/jquery.grouprequired.js)  (4.14kB, 1.32kB gzipped)

#### CDN
```html
<script src="https://unpkg.com/jquery-grouprequired@2.3.0/dist/jquery.grouprequired.min.js"></script>
<!-- OR -->
<script src="https://unpkg.com/jquery-grouprequired@2.3.0/dist/jquery.grouprequired.js"></script>
```
